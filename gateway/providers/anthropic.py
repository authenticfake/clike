...
async def chat(base_url: str, api_key: str, model: str, messages: list, temperature: float, max_tokens: int, timeout: Optional[float] = 240.0,  top_p: Optional[float] = None ) -> str:
    headers = {
