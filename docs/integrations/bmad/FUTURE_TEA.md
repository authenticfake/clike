...
Future TEA support may provide a structured method for improving reasoning, evidence, or traceability across Harper phases.
...
TEA must not become a hidden gate override or an alternate promotion path.
